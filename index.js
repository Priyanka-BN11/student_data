...
// get the list of data about all students
...
// add data for a new student to our list of students.
...
// delete a student from our list by ID
...
app.put('/students/:name/:class/:grade',(req,res) => {
    ...
    if(student) {
        students.classes[req.params.class] = parseInt(req.params.grade);
